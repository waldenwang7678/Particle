...
import walden.com.particleanimationtest.smash.Utils;
import walden.com.particleanimationtest.smash.particle.ExplodeParticle;
...
public class ExplodeParticleFactory extends ParticleFactory{
    ...
    public Particle1[][] generateParticles(Bitmap bitmap, Rect bound) {
        ...
        int bitmap_part_w = bitmap.getWidth() / partW_Count;    //区域块宽度
        int bitmap_part_h = bitmap.getHeight() / partH_Count;   //区域块高度

        Particle1[][] particles = new Particle1[partH_Count][partW_Count];
    ...
    private Particle1 generateParticle(int color, Random random) {
